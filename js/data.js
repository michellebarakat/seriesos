...
const curatedCollection = [
  ...
  new CuratedItem(4, "Criminal Minds", "Crime & Thrillers",
    ...
    "Great for marathon watching, genuinely felt smarter after every episode, not boring even though 18 seasons, my whole family watched with me as it was on the TV 24/7 ."),
  ...
  new CuratedItem(25, "Love Island", "Reality & Competition",
    ...
    "Addictive format, you'll have strong opinions about people you've never met. Always new serie during midterms or finals, still was very up-to-date. Currently watching as you read."),
  ...
  new CuratedItem(20, "Lost", "Must-Watch / OG Classics",
    ...
    "A defining mystery-box show, frustrating and brilliant in equal measure. Very original and characters are iconic, my mom spoilt it for my sister and I but still finished it."),
  new CuratedItem(26, "Suits", "Must-Watch / OG Classics",
    "A brilliant college dropout bluffing his way through a top law firm.",
    "Slick, fast-talking, and impossible to stop watching. Harvey Specter is iconic. Not a fan of Mike at all. Also watched it 2 times. "),
  new CuratedItem(27, "Desperate Housewives", "Must-Watch / OG Classics",
    "Secrets, scandals, and murder, all behind white picket fences.",
    "Ahead of its time. Equal parts dark comedy and thriller, never boring for a second. My sister was hooked with me by watching one episode after saying she wont't like it."),
